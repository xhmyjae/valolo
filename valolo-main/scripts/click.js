...
/* allows the js script to start as the window loads */
window.onload = function () {

    music()

    /* change the situation by clicking on the choices during the conversation */
    ...
    /* change the background by clicking on the icons, and change the visible icons for each scene */
